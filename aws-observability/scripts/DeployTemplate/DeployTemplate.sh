...
aws s3 cp s3://appdevzipfiles-us-east-1/sumologic-aws-observability-pre-prod/templates/sumologic_observability.master.template.yaml sumologic_observability_template.yaml
